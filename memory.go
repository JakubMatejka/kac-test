// https://github.com/go-git/go-billy/blob/master/memfs/memory.go

// Package memfs provides a billy filesystem base on memory.
package main // import "github.com/go-git/go-billy/v5/memfs"
...
func NewMemory(directory string) billy.Filesystem {
	fs := &Memory{s: newStorage(), directory: directory}
